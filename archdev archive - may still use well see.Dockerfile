...
# Install: mkcert .... its make certificate for running localhost https
#     mkcert -install
#     mkcert localhost
#
# NNN & Broot
...
# Install Rust via homebrew instead. brew install rustup. then use rustup-init to install the rest
#
# nvim
